            ...
            <div className="relative flex items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div className="hidden sm:block">
                  <input
                    type="text"
                    className="w-full mb-4 sm:mb-0 mr-6 pl-4 sm:pl-10 pr-4 sm:pr-6 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    placeholder="Search..."
                  />
                </div>
                <button
                ...
                >
                  ...
                  <span className="absolute top-0 right-0 bg-red-500 text-white rounded-full w-4 h-4 text-xs flex items-center justify-center">5</span>
                </button>
